...
contextBridge.exposeInMainWorld('aether', {
  ...
  deleteConversation: input => ipcRenderer.invoke('conversation:delete', input),
  clearConversations: input => ipcRenderer.invoke('conversation:clear', input),
  ...
  onConversationDeleted: on('conversation:deleted'),
  onConversationsCleared: on('conversation:cleared'),
